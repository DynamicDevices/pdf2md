...
This diagram shows the top view of the 48-pin RGZ package for the CC1312R7 microcontroller. It is a square QFN (Quad Flat No-leads) package measuring 7-mm x 7-mm with a 0.5-mm pitch. The pins are numbered counter-clockwise around the package.
